					 ...
					 $.ajax({
						...
						success: function(html){
						  if(html=='true')
						  {
							...
							window.location.href = "sgl/VideoSharingPortal/sglx.php";
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
					...
					<strong>You must be logged in to view the SGLX.</strong>
					<strong>You can give the same credentials you gave to login in the BLOG section.</strong>
					</div>
