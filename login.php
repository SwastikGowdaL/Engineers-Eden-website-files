...
<head>
    ...
    <title>Engineers Eden - Register</title>
					 ...
					 $.ajax({
						...
						success: function(html){
						  if(html=='true')
						  {
							...
							window.location.href = "blog5.php";
						  
						  } else if (html=='false') {
								$("#add_err2").html('<div class="alert alert-danger"> \
													<strong>Authentication</strong> failure USN or password incorrect. \ \
												</div>');
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Login <i class="fi-xtluxx-sign-in-thin"></i></strong>
                    </h2>
					<div id="add_err2"></div>
                    <hr>       
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <label for="remember-me">Remember me(Beta Testing)</label>  
                            </div>
                            <div class="form-group col-lg-12">
                                <button type="submit" id="login" class="btn btn-default"><i class="fi-xtluxl-sign-in-thin"></i> Login </button>
                            </div>
                        </div>
                    </form>
					<div class="form-group col-lg-12">
						<a href="#"><button type="submit" class="btn btn-default">Change/Forgot password(Disabled)</button></a>
					</div>
					<div class="form-group col-lg-12">
