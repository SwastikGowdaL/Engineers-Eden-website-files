                    ...
                    success: function (html) {
                        if (html == 'true') {
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>USN</strong> already in system. \ \
                                                 </div>');                    
                        } else if (html == 'fname') {
                            $("#add_err2").html('<div class="alert alert-danger"> \
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Enter valid USN</strong> Eg - Type only 170 if usn is 1DA18CS170. \ \
                                                 </div>');
...
<body>
    ...
    <div class="brand">Engineers Eden</div>
    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center"> <i class="fi-xnluxx-user-plus"></i> Registration
                        <strong>form</strong>
                    </h2>
					<div id="add_err2"></div>
                    <hr>       
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                <label>Email</label>
                                <input type="text" id="lname" name="lname" maxlength="35" class="form-control">
                            </div>
                            <div class="form-group col-lg-4">
                                <label>USN</label>
